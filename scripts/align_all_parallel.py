...
def get_landmark(filepath, predictor, default_lm=[]):
	...
	try:
		...
		lm = default_lm
		print('cannot align face, use default lm instead...') 
  # t = list(shape.parts()) 
  # a = []
  # for tt in t:
  #   a.append([tt.x, tt.y])
...
def align_face(filepath, predictor, default_lm=[]):
	"""
	:param filepath: str
	:return: PIL Image
	"""

	lm = get_landmark(filepath, predictor, default_lm)
